...
#pragma mark - init
bool E002_C010_CompletePopup::init(int pageNumber)
{
...
void E002_C010_CompletePopup::onEnter()
{
    E002_Base_CompletePopup::onEnter();
}

void E002_C010_CompletePopup::onExit()
{
...
void E002_C010_CompletePopup::onTouchedReplayBtn()
{
...
void E002_C010_CompletePopup::onTouchedNextBtn()
{
    CCLog("onTouch Next");
    ...
    switch (mPageNumber) {
        ...
        case P300:
            //temp
            replaceSceneTransitionFadeOut(E002_C010_P000_Index);
            break;
        default:
            break;
    }
