...
bool E002_C030_P000_Index::init()
{
...
void E002_C030_P000_Index::onEnter()
{
    E002_Base_P000_Index::onEnter();
    onViewLoad();
}

void E002_C030_P000_Index::onExit()
{
    E002_Base_P000_Index::onExit();
}


void E002_C030_P000_Index::onViewLoad()
{
    E002_Base_P000_Index::onViewLoad();
}

void E002_C030_P000_Index::onViewLoaded()
{
    E002_Base_P000_Index::onViewLoaded();
    
    //play bgm
    CJMultimedia::getInstance()->playBGM(getFilePath("snd","e002_c030_snd_bgm_main.mp3"), true);
    
}

#pragma mark - navigation delegate
void E002_C030_P000_Index::onTouchedNavigationButtonAtPackage()
{
...
void E002_C030_P000_Index::goToSelectedPage(CCNode* sender, void* index)
{
    ...
    switch (pageNum) {
        case 0:
            replaceSceneTransitionFadeOut(E002_C030_P000_PreStory);
            break;
        case 1:
             replaceSceneTransitionFadeOut(E002_C030_P100_Intro);
            break;
        case 2:
            replaceSceneTransitionFadeOut(E002_C030_P000_Lecture);
            break;
        case 3:
